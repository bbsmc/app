  ...
  <div ref="main_page" class="layout" :class="{ 'expanded-mobile-nav': isBrowseMenuOpen }">
    ...
    <header
      ...
      <div :class="`gap-2} col-span-2 row-start-2 flex flex-wrap justify-center lg:col-span-1 lg:row-start-auto`">
        ...
        <ButtonStyled type="transparent"
          :highlighted="route.path.startsWith('/forums/') || route.path.startsWith('/d/')" :highlighted-style="route.path.startsWith('/forums/') || route.path.startsWith('/d/') ? 'main-nav-primary' : 'main-nav-secondary'
            ">
          <nuxt-link to="/forums/chat">
            <MessageIcon aria-hidden="true" /> 论坛
          </nuxt-link>
        </ButtonStyled>
        <!--        -->
        <!--        -->
