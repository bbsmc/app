        ...
        <div class="normal-page__content">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div v-if="type === 'chat' || (auth.user && auth.user.role === 'admin')">
                    <ButtonStyled color="green" v-if="!createForumModel">
                        <button @click="createForum">发帖</button>
                    </ButtonStyled>
                    <ButtonStyled color="red" v-else>
            ...
            <div v-if="createForumModel">
                ...
                <div class="universal-card">
                    ...
                    <div class="flex flex-col gap-2" style="margin-bottom: 30px;">
                        ...
                        <input id="name" v-model="forumTitle" type="text" maxlength="64" placeholder="帖子标题"
                            autocomplete="off" />
                    </div>
                    ...
                    <div class="forum-header">
                        ...
                        <div class="forum-info">
                            ...
                            <p class="forum-meta">
                                ...
                                <span class="forum-date" style="margin-left: 4px;">{{ formatDateTime(forum.created_at)
                                    }}</span>
                            </p>
                        </div>
                    </div>
